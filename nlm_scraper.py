...
def clean_data(list_element, seperator=' '):
	'''
	The function cleans the list provided with proper seperators and returns a string
	'''
	if not list_element:
		return None
	text = ' '.join(seperator.join(list_element).split()).strip()
